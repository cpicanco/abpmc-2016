...
SQUARE = (362./SCREEN_WIDTH_PX, 319./SCREEN_HEIGHT_PX)
CIRCLE = (854./SCREEN_WIDTH_PX, 384./SCREEN_HEIGHT_PX)
S_SIZE = (130./SCREEN_WIDTH_PX, 130./SCREEN_HEIGHT_PX)

SQUARE_P = (SQUARE[0],SQUARE[1],SQUARE[0]+S_SIZE[0],SQUARE[1]+S_SIZE[1])
